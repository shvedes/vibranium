...
Hypr.Anim.apply({
  curves = {
    ...
    { "hobbyist", { type = "spring", mass = 1, stiffness = 150, dampening = 20 } },
    { "cat", { type = "spring", mass = 1, stiffness = 200, dampening = 20 } },
  },
  ...
  animations = {
    ...
    { leaf = "layers", enabled = true, speed = 3, spring = "cat" },
    { leaf = "layersIn", enabled = true, speed = 3, bezier = "easeOutQuint", style = "slide" },
    { leaf = "layersOut", enabled = true, speed = 3, spring = "cat", style = "slide" },
    { leaf = "fadeLayersIn", enabled = true, speed = 0.695, bezier = "almostLinear" },
    { leaf = "fadeLayersOut", enabled = true, speed = 0.695, bezier = "almostLinear" },
    { leaf = "workspaces", enabled = true, speed = 3, spring = "hobbyist", style = "slidevert" },
    { leaf = "workspacesIn", enabled = true, speed = 3, spring = "hobbyist", style = "slidevert" },
    { leaf = "workspacesOut", enabled = true, speed = 3, spring = "hobbyist", style = "slidevert" },
