...
- Vibranium Menu (`CTRL ALT V`) -> Settings -> Misc -> Edit Env
...
To do this, create a file named `env.lua` inside `~/.config/hypr/hyprland.conf.d/` and configure it as needed.  
Follow [this link](https://wiki.hypr.land/Configuring/Advanced-and-Cool/Environment-variables/) for syntax details.
