...
Once your UEFI is in Setup Mode, go to *Vibranium Menu* (`CTRL ALT V`) -> *Setup* -> *Secure Boot*. When prompted by the setup script, type `y` or press Enter, then wait a few seconds. That’s it.
