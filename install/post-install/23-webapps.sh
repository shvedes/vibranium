...
vb-webapp-install --category PWA --url 'mail.google.com/mail/u/0/#inbox' --icon gmail --name Gmail
vb-webapp-install --category PWA --url 'youtube.com' --icon youtube --name YouTube
vb-webapp-install --category PWA --url 'reddit.com' --icon reddit --name Reddit
vb-webapp-install --category PWA --url 'github.com' --icon github --name GitHub
vb-webapp-install --category PWA --url 'x.com' --icon x-twitter --name X
